...
immoments
(imagename="HCG16_CD_rob2_MS_cleanmask.image",moments=[0],axis="spectral",region="",box="",chans="0",stokes="",mask="",includepix=[0.00108, 1000000],excludepix=-1,outfile="HCG16_CD_rob2_MS_cleanmask.mom0",stretch=False)
...
imregrid
(imagename="HCG16_CD_rob2_MS_cleanmask.mom0.pbcor",template="J2000",output="HCG16_CD_rob2_MS.J2000.mom0.pbcor",asvelocity=True,axes=[-1],shape=[-1],interpolation="linear",decimate=10,replicate=False,overwrite=False)

exportfits
(imagename="HCG16_CD_rob2_MS.J2000.mom0.pbcor",fitsimage="HCG16_CD_rob2_MS.mom0.pbcor.fits",velocity=True,optical=False,bitpix=-32,
minpix=0,maxpix=-1,overwrite=True,dropstokes=True,stokeslast=True,
history=True,dropdeg=False)
